...
<body>
    ...
    <table>
        ...
        if (!empty($search)) {
            $sql = "SELECT * FROM rep_vac WHERE vet_id = $Vet_id AND farmer_name LIKE '%$search%' ORDER BY ID_fermier ASC";
        } else {
            $sql = "SELECT * FROM rep_vac WHERE vet_id = $Vet_id ORDER BY ID_fermier ASC";
        }
