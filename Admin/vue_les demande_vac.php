...
<head>
    <meta charset="UTF-8">
    <title> list demande vaccination</title>
    <style>
        body {
...
<div class="btn">
    ...
    <button class="btn_vac" onclick="navigateTo('vue_les demande_vac.php', 'vaccination')">demande vaccination</button>
</div>
...
<tr>
    ...
    if (!empty($search)) {
        $sql = "SELECT * FROM demande_vaccination WHERE vet_id LIKE '%$search%' ORDER BY date ASC ";
    } else {
        $sql = "SELECT * FROM demande_vaccination  ORDER BY date ASC";
    }
