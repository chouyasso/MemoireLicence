...
<body>
<div class="btn">
    <button class="btn_con" onclick="navigateTo('vue_les_reponce_con.php', 'vaccination')">Reponse conn</button>
    <button class="btn_vac" onclick="navigateTo('vue_les_reponce_Vac.php', 'consultation')">Reponse vacc</button>
</div>

<h2>les reponse de consultation</h2>
...
<tr>
    ...
    if (!empty($search)) {
        $sql = "SELECT * FROM rep_con WHERE vet_id LIKE '%$search%' ORDER BY nouvaeu_date ASC ";
    } else {
        $sql = "SELECT * FROM rep_con  ORDER BY nouvaeu_date ASC";
    }
